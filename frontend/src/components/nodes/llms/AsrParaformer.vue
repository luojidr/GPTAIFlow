...
<template>
  <BaseNode :nodeId="id" :title="t('components.nodes.llms.AsrParaformer.title')" :description="props.data.description"
    documentLink="https://vectorvein.com/help/docs/language-models#h2-4">
    <template #main>
      <a-row type="flex">
        <a-col :span="24">
          <BaseField id="prompt" :name="t('components.nodes.llms.AsrParaformer.prompt')" required type="target"
        ...
        <a-col :span="24">
          <BaseField id="llm_model" :name="t('components.nodes.llms.AsrParaformer.llm_model')" required type="target"
        ...
        <a-col :span="24">
          <BaseField id="temperature" :name="t('components.nodes.llms.AsrParaformer.temperature')" required type="target"
    ...
    <template #output>
      <BaseField id="output" :name="t('components.nodes.llms.AsrParaformer.output')" type="source" nameOnly>
      </BaseField>
    </template>
  </BaseNode>
</template>
