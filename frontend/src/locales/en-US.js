...
export default {
  ...
  workspace: {
    ...
    databaseObjectCreate: {
      ...
      'split_method_chapter': 'Chapter split',
  ...
  components: {
    layout: {
      ...
      helpDropdown: {
        ...
        'about_vectorvein': 'About AIGC Chain',
        'about_vectorvein_description': '### Build Your Automated Workflow with the Power of AI\n#### Create powerful workflows with drag-and-drop functionality, no programming required.\n\nThe open-source version of AIGC Chain, developed by MakerBi, is available for personal use only and cannot be used for commercial purposes.',
      },
    },
    markdownEditor: {
      'raw_text': 'Raw text',
    ...
    nodes: {
      ...
      llms: {
        ...
        BaiChuan: {
          'title': 'BaiChuan',
          'description': 'BaiChuan series models, through the injection of code pre-training, supervised fine-tuning and other technologies to align human intentions, with question and answer, multi-round dialogue, code generation and other capabilities.',
          'prompt': 'Prompt',
          'llm_model': 'Model',
          'temperature': 'AI preference (temperature)',
          'creative': 'Creative',
      ...
      tools: {
        ...
        WorkflowLoopInvoke: {
          'title': 'Workflow loop invoke',
          'description': 'sed to loop invoke the workflow and get the result.',
          'select_workflow': 'Select workflow',
          'selected_workflow': 'Selected workflow',
          'loop_count': 'Loop count',
          'loop_output': 'Output',
          'loop_end_exp': 'Set the end condition of the loop',
          'loop_end_exp_code': 'End condition code',
          'workflow_id': 'Workflow ID',
          'fail_all': 'If this node fails, the entire workflow fails',
          'list_input': 'List input',
          'workflow_fields': 'Workflow fields',
